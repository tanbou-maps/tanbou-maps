...
ActiveRecord::Schema[7.0].define(version: 20_241_125_010_444) do
  ...
  create_table 'course_spots', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index %w[model_course_id order_number], name: 'index_course_spots_on_model_course_id_and_order_number',
                                              unique: true
